  ...
  useEffect(() => {
    const fetchCard = async () => {
      ...
      try {
        ...
        toast.error('An error occurred while loading the card');
        router.push('/cards');
      } finally {
        setIsLoading(false);
      }
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto">
          ...
          {isLoading ? (
            ...
            <>
              <CardContent>
                <form id="edit-card-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select 
                        ...
                        defaultValue={originalCard?.rarity || 'Common'}
                      >
                        <SelectTrigger>
