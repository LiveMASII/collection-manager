  ...
  useEffect(() => {
    const fetchWishlistItem = async () => {
      ...
      try {
        ...
        if (wishlistItem.user !== user.username) {
          toast.error('You do not have permission to edit this item');
          router.push('/wishlist');
          return;
        }
        
        setOriginalItem(wishlistItem);
        ...
        reset({
          ...
          maxPrice: wishlistItem.maxPrice.toString(),
          type: wishlistItem.type,
          priority: wishlistItem.priority
        });
      } catch (error) {
        console.error('Error fetching wishlist item:', error);
        toast.error('An error occurred while loading the wishlist item');
        router.push('/wishlist');
      } finally {
        setIsLoading(false);
      }
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(result.message || 'Failed to update wishlist item');
      }
    } catch (error) {
      console.error('Error updating wishlist item:', error);
      toast.error('An error occurred while updating the wishlist item');
    } finally {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle>Edit Wishlist Item</CardTitle>
            <CardDescription>
          ...
          {isLoading ? (
            ...
            <>
              <CardContent>
                <form id="edit-wishlist-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <CardFooter className="flex justify-between">
                ...
                <Button type="submit" form="edit-wishlist-form" disabled={isSubmitting}>
                  {isSubmitting ? (
                    <>
